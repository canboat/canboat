...
/// Prepended to every emitted document. The XML is generated, and people do
/// find it before they find the database.
...
<!--
  ==========================================================================
    ...
    This document is written by `keel` from the YAML database in database/.
    Editing it achieves nothing: the next `make generated` overwrites it,
    and CI fails the build on the resulting diff.
...
impl<'a> Emitter<'a> {
    ...
    fn header(&mut self, styled: bool) {
        ...
        // JSON has no comment syntax, so this element -- which survives the XSLT
        // into canboat.json -- is the only place a "don't edit me" notice can
        // reach a reader of the JSON.
        self.p(
            "  <Comment>GENERATED FILE - DO NOT EDIT. Generated by keel from the YAML database in database/; \
edit database/pgns/*.yaml and run 'make generated'. See https://github.com/canboat/canboat for the full source code</Comment>\n",
        );
        self.p(&format!(
