...
static int addAisInt(long int value, int len, aisVector *payload)
{
  ...
  if (value >= (long int)(1 << len) || value < -(long int)(1 << (len - 1))) return 0;
...
static int addAisString(char* string, int len, aisVector *payload)
{
  ...
  while (len >= 6) {
    ...
    else if (nextchar < 32 || nextchar > 95) nextchar = 32;
    else if (nextchar >= 64) nextchar -= 64;
...
static int addAisLongString(const char *msg, const char *fieldName, int maxSize, bool padd, aisVector *payload)
{
  ...
  for (len = 0 ; len <= maxSize ; len++) {
    if (*(jsonString + len) == '\0') break;
  }

  len *= 6;
  if (padd) if (len%8) len += 8 - (len % 8);  // Add padd bits
...
char nextPayloadChar(aisVector *bitVec, int *opos, unsigned char *padding)
{
  ...
  if (*opos >= bitVec->pos ) return '\0';

  if (bitVec->pos - *opos < 6) *padding = 6 - (bitVec->pos - *opos);

  i = (bitVec->bitVector[start] << (*opos % 8));
  i = i >> 2;
  if ((8 - *opos % 8) + *padding < 6) i |= (unsigned char) bitVec->bitVector[start+1] >> (10 - (*opos % 8));
  i &= 0xff << *padding;
  // Make shure *opos does not exceede bitVec->pos
  *opos += 6 - *padding;

  // Ascii encode the 6-bit value before return
  if (i < 40) return (char)(i + 48);
  else return (char)(i + 56);
}
...
static void aisToNmea0183( StringBuffer *msg183, int src, char *aisTalkerId, char channel, aisVector *bitVec )
{
  ...
  if (bitVec->pos % 360) fragments++;
  // We maintain 10 sequential message ID for multi-sentence messages
  if (fragments > 1) sequenceId = (((sequenceId - 48) + 1) % 10) + 48;
  ...
  while (fragCntr <= fragments) {
    ...
    if (fragments > 1) {
      nmea0183CreateMessage(msg183, src, "%s,%d,%d,%c,%c,%s,%d", aisTalkerId, fragments, fragCntr, sequenceId, channel, payload, padding);
      }
    else {
...
long int aisInteger(const char *msg, const char *fieldName)
{
  ...
  static const int p3 = 'C'+'o'+'m'+'m'+'u'+'n'+'i'+'c'+'a'+'t'+'i'+'o'+'n'+' '+'S'+'t'+'a'+'t'+'e';
  ...
  // Calculate index
  for (i = 0 ; fieldName[i] != '\0' ; i++) h += fieldName[i];
  for (i = 0 ; i < sizeof(paramRange) / sizeof(intParam) ; i++ ) {
    if ( paramRange[i].hash == h && !strcmp(fieldName, paramRange[i].value) ) break;
  }

  if ( !getJSONValue(msg, fieldName, jsonString, sizeof(jsonString)) ) return paramRange[i].defValue;
  if ( jsonString[0] == '\0' ) return paramRange[i].defValue;
  value = atol(jsonString);
  if ( value >= paramRange[i].min && value <= paramRange[i].max ) return value;
  if ( paramRange[i].hash != p2 ) return paramRange[i].defValue;
...
#define ALTITUDE_MULTIPLICATOR (1.0)
  ...
  enum {
      ...
      p6 = 'L'+'e'+'n'+'g'+'t'+'h',
      p7 = 'B'+'e'+'a'+'m',
      p8 = 'P'+'o'+'s'+'i'+'t'+'i'+'o'+'n'+' '+'r'+'e'+'f'+'e'+'r'+'e'+'n'+'c'+'e'+' '+'f'+'r'+'o'+'m'+' '+'S'+'t'+'a'+'r'+'b'+'o'+'a'+'r'+'d',
      p9 = 'P'+'o'+'s'+'i'+'t'+'i'+'o'+'n'+' '+'r'+'e'+'f'+'e'+'r'+'e'+'n'+'c'+'e'+' '+'f'+'r'+'o'+'m'+' '+'B'+'o'+'w',
      p10 = 'D'+'r'+'a'+'f'+'t',
      p11 = 'T'+'r'+'u'+'e'+' '+'H'+'e'+'a'+'d'+'i'+'n'+'g',
      p12 = 'L'+'e'+'n'+'g'+'t'+'h'+'/'+'D'+'i'+'a'+'m'+'e'+'t'+'e'+'r',
      p13 = 'B'+'e'+'a'+'m'+'/'+'D'+'i'+'a'+'m'+'e'+'t'+'e'+'r',
      p14 = 'P'+'o'+'s'+'i'+'t'+'i'+'o'+'n'+' '+'R'+'e'+'f'+'e'+'r'+'e'+'n'+'c'+'e'+' '+'f'+'r'+'o'+'m'+' '+'S'+'t'+'a'+'r'+'b'+'o'+'a'+'r'+'d'+' '+'E'+'d'+'g'+'e',
      p15 = 'P'+'o'+'s'+'i'+'t'+'i'+'o'+'n'+' '+'R'+'e'+'f'+'e'+'r'+'e'+'n'+'c'+'e'+' '+'f'+'r'+'o'+'m'+' '+'T'+'r'+'u'+'e'+' '+'N'+'o'+'r'+'t'+'h'+' '+'F'+'a'+'c'+'i'+'n'+'g'+' '+'E'+'d'+'g'+'e',
      p16 = 'A'+'l'+'t'+'i'+'t'+'u'+'d'+'e'
  };
  ...
  result *= sign;
  if ( result < paramRange[i].min ) return paramRange[i].min;
  if ( result > paramRange[i].max && result != paramRange[i].defValue) return paramRange[i].max;
  return result;
}
...
int aisEnum(const char *msg, const char *fieldName)
{
  ...
  static const int t5 = 'A'+'I'+'S'+' '+'T'+'r'+'a'+'n'+'s'+'c'+'e'+'i'+'v'+'e'+'r'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n';
  ...
  static const int t10 = 'A'+'I'+'S'+' '+'c'+'o'+'m'+'m'+'u'+'n'+'i'+'c'+'a'+'t'+'i'+'o'+'n'+' '+'s'+'t'+'a'+'t'+'e';
  static const int t11 = 'U'+'n'+'i'+'t'+' '+'t'+'y'+'p'+'e';
  static const int t12 = 'I'+'n'+'t'+'e'+'g'+'r'+'a'+'t'+'e'+'d'+' '+'D'+'i'+'s'+'p'+'l'+'a'+'y';
  static const int t13 = 'A'+'I'+'S'+' '+'v'+'e'+'r'+'s'+'i'+'o'+'n'+' '+'i'+'n'+'d'+'i'+'c'+'a'+'t'+'o'+'r';
  ...
  static const int t19 = 'O'+'f'+'f'+' '+'P'+'o'+'s'+'i'+'t'+'i'+'o'+'n'+' '+'I'+'n'+'d'+'i'+'c'+'a'+'t'+'o'+'r';
  ...
  static const int h1 = 'F'+'i'+'r'+'s'+'t'+' '+'r'+'e'+'t'+'r'+'a'+'n'+'s'+'m'+'i'+'s'+'s'+'i'+'o'+'n';
  static const int h2 = 'S'+'e'+'c'+'o'+'n'+'d'+' '+'r'+'e'+'t'+'r'+'a'+'n'+'s'+'m'+'i'+'s'+'s'+'i'+'o'+'n';
  static const int h3 = 'F'+'i'+'n'+'a'+'l'+' '+'r'+'e'+'t'+'r'+'a'+'n'+'s'+'m'+'i'+'s'+'s'+'i'+'o'+'n';

  static const int h4 = 'U'+'n'+'d'+'e'+'r'+' '+'w'+'a'+'y'+' '+'u'+'s'+'i'+'n'+'g'+' '+'e'+'n'+'g'+'i'+'n'+'e';
  static const int h5 = 'A'+'t'+' '+'a'+'n'+'c'+'h'+'o'+'r';
  static const int h6 = 'N'+'o'+'t'+' '+'u'+'n'+'d'+'e'+'r'+' '+'c'+'o'+'m'+'m'+'a'+'n'+'d';
  static const int h7 = 'R'+'e'+'s'+'t'+'r'+'i'+'c'+'t'+'e'+'d'+' '+'m'+'a'+'n'+'o'+'e'+'u'+'v'+'e'+'r'+'a'+'b'+'i'+'l'+'i'+'t'+'y';
  static const int h8 = 'C'+'o'+'n'+'s'+'t'+'r'+'a'+'i'+'n'+'e'+'d'+' '+'b'+'y'+' '+'h'+'e'+'r'+' '+'d'+'r'+'a'+'u'+'g'+'h'+'t';
  ...
  static const int h13 = 'H'+'a'+'z'+'a'+'r'+'d'+'o'+'u'+'s'+' '+'m'+'a'+'t'+'e'+'r'+'i'+'a'+'l'+' '+'-'+' '+'H'+'i'+'g'+'h'+' '+'S'+'p'+'e'+'e'+'d';
  static const int h14 = 'H'+'a'+'z'+'a'+'r'+'d'+'o'+'u'+'s'+' '+'m'+'a'+'t'+'e'+'r'+'i'+'a'+'l'+' '+'-'+' '+'W'+'i'+'n'+'g'+' '+'i'+'n'+' '+'G'+'r'+'o'+'u'+'n'+'d';
  ...
  static const int h24 = 'D'+'e'+'a'+'d'+' '+'r'+'e'+'c'+'k'+'o'+'n'+'i'+'n'+'g'+' '+'m'+'o'+'d'+'e';
  static const int h25 = 'P'+'o'+'s'+'i'+'t'+'i'+'o'+'n'+'i'+'n'+'g'+' '+'s'+'y'+'s'+'t'+'e'+'m'+' '+'i'+'s'+' '+'i'+'n'+'o'+'p'+'e'+'r'+'a'+'t'+'i'+'v'+'e';
  static const int h26 = 'n'+'o'+'t'+' '+'i'+'n'+' '+'u'+'s'+'e';
  static const int h27 = 'i'+'n'+' '+'u'+'s'+'e';
  static const int h28 = 'C'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'A'+' '+'V'+'D'+'L'+' '+'r'+'e'+'c'+'e'+'p'+'t'+'i'+'o'+'n';
  static const int h29 = 'C'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'B'+' '+'V'+'D'+'L'+' '+'r'+'e'+'c'+'e'+'p'+'t'+'i'+'o'+'n';
  static const int h30 = 'C'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'A'+' '+'V'+'D'+'L'+' '+'t'+'r'+'a'+'n'+'s'+'m'+'i'+'s'+'s'+'i'+'o'+'n';
  static const int h31 = 'C'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'B'+' '+'V'+'D'+'L'+' '+'t'+'r'+'a'+'n'+'s'+'m'+'i'+'s'+'s'+'i'+'o'+'n';
  static const int h32 = 'O'+'w'+'n'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+' '+'n'+'o'+'t'+' '+'b'+'r'+'o'+'a'+'d'+'c'+'a'+'s'+'t';
  static const int h33 = 'R'+'e'+'s'+'e'+'r'+'v'+'e'+'d';
  static const int h34 = 'N'+'o';
  static const int h35 = 'Y'+'e'+'s';
  static const int h36 = 't'+'o'+' '+'5'+'2'+'5'+' '+'k'+'H'+'z'+' '+'o'+'f'+' '+'m'+'a'+'r'+'i'+'n'+'e'+' '+'b'+'a'+'n'+'d';
  ...
  static const int h53 = 'W'+'i'+'n'+'g'+' '+'I'+'n'+' '+'G'+'r'+'o'+'u'+'n'+'d'+' '+'('+'n'+'o'+' '+'o'+'t'+'h'+'e'+'r'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+')';
  static const int h54 = 'F'+'i'+'s'+'h'+'i'+'n'+'g';
  static const int h55 = 'T'+'o'+'w'+'i'+'n'+'g';
  static const int h56 = 'T'+'o'+'w'+'i'+'n'+'g'+' '+'e'+'x'+'c'+'e'+'e'+'d'+'s'+' '+'2'+'0'+'0'+'m'+' '+'o'+'r'+' '+'w'+'i'+'d'+'e'+'r'+' '+'t'+'h'+'a'+'n'+' '+'2'+'5'+'m';
  static const int h57 = 'E'+'n'+'g'+'a'+'g'+'e'+'d'+' '+'i'+'n'+' '+'d'+'r'+'e'+'d'+'g'+'i'+'n'+'g'+' '+'o'+'r'+' '+'u'+'n'+'d'+'e'+'r'+'w'+'a'+'t'+'e'+'r'+' '+'o'+'p'+'e'+'r'+'a'+'t'+'i'+'o'+'n'+'s';
  static const int h58 = 'E'+'n'+'g'+'a'+'g'+'e'+'d'+' '+'i'+'n'+' '+'d'+'i'+'v'+'i'+'n'+'g'+' '+'o'+'p'+'e'+'r'+'a'+'t'+'i'+'o'+'n'+'s';
  static const int h59 = 'E'+'n'+'g'+'a'+'g'+'e'+'d'+' '+'i'+'n'+' '+'m'+'i'+'l'+'i'+'t'+'a'+'r'+'y'+' '+'o'+'p'+'e'+'r'+'a'+'t'+'i'+'o'+'n'+'s';
  static const int h60 = 'S'+'a'+'i'+'l'+'i'+'n'+'g';
  static const int h61 = 'P'+'l'+'e'+'a'+'s'+'u'+'r'+'e';
  static const int h62 = 'H'+'i'+'g'+'h'+' '+'s'+'p'+'e'+'e'+'d'+' '+'c'+'r'+'a'+'f'+'t';
  static const int h63 = 'H'+'i'+'g'+'h'+' '+'s'+'p'+'e'+'e'+'d'+' '+'c'+'r'+'a'+'f'+'t'+' '+'c'+'a'+'r'+'r'+'y'+'i'+'n'+'g'+' '+'d'+'a'+'n'+'g'+'e'+'r'+'o'+'u'+'s'+' '+'g'+'o'+'o'+'d'+'s';
  static const int h64 = 'H'+'i'+'g'+'h'+' '+'s'+'p'+'e'+'e'+'d'+' '+'c'+'r'+'a'+'f'+'t'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'B';
  static const int h65 = 'H'+'i'+'g'+'h'+' '+'s'+'p'+'e'+'e'+'d'+' '+'c'+'r'+'a'+'f'+'t'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'C';
  static const int h66 = 'H'+'i'+'g'+'h'+' '+'s'+'p'+'e'+'e'+'d'+' '+'c'+'r'+'a'+'f'+'t'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'D';
  static const int h67 = 'H'+'i'+'g'+'h'+' '+'s'+'p'+'e'+'e'+'d'+' '+'c'+'r'+'a'+'f'+'t'+' '+'('+'n'+'o'+' '+'a'+'d'+'d'+'i'+'t'+'i'+'o'+'n'+'a'+'l'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+')';
  ...
  static const int h77 = 'R'+'R'+' '+'R'+'e'+'s'+'o'+'l'+'u'+'t'+'i'+'o'+'n'+' '+'N'+'o'+'.'+'1'+'8';
  static const int h78 = 'P'+'a'+'s'+'s'+'e'+'n'+'g'+'e'+'r'+' '+'s'+'h'+'i'+'p';
  static const int h79 = 'P'+'a'+'s'+'s'+'e'+'n'+'g'+'e'+'r'+' '+'s'+'h'+'i'+'p'+' '+'('+'n'+'o'+' '+'a'+'d'+'d'+'i'+'t'+'i'+'o'+'n'+'a'+'l'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+')';
  static const int h80 = 'C'+'a'+'r'+'g'+'o'+' '+'s'+'h'+'i'+'p';
  static const int h81 = 'C'+'a'+'r'+'g'+'o'+' '+'s'+'h'+'i'+'p'+' '+'c'+'a'+'r'+'r'+'y'+'i'+'n'+'g'+' '+'d'+'a'+'n'+'g'+'e'+'r'+'o'+'u'+'s'+' '+'g'+'o'+'o'+'d'+'s';
  static const int h82 = 'C'+'a'+'r'+'g'+'o'+' '+'s'+'h'+'i'+'p'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'B';
  static const int h83 = 'C'+'a'+'r'+'g'+'o'+' '+'s'+'h'+'i'+'p'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'C';
  static const int h84 = 'C'+'a'+'r'+'g'+'o'+' '+'s'+'h'+'i'+'p'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'D';
  static const int h85 = 'C'+'a'+'r'+'g'+'o'+' '+'s'+'h'+'i'+'p'+' '+'('+'n'+'o'+' '+'a'+'d'+'d'+'i'+'t'+'i'+'o'+'n'+'a'+'l'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+')';
  static const int h86 = 'T'+'a'+'n'+'k'+'e'+'r';
  static const int h87 = 'T'+'a'+'n'+'k'+'e'+'r'+' '+'c'+'a'+'r'+'r'+'y'+'i'+'n'+'g'+' '+'d'+'a'+'n'+'g'+'e'+'r'+'o'+'u'+'s'+' '+'g'+'o'+'o'+'d'+'s';
  static const int h88 = 'T'+'a'+'n'+'k'+'e'+'r'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'B';
  static const int h89 = 'T'+'a'+'n'+'k'+'e'+'r'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'C';
  static const int h90 = 'T'+'a'+'n'+'k'+'e'+'r'+' '+'h'+'a'+'z'+'a'+'r'+'d'+' '+'c'+'a'+'t'+' '+'D';
  static const int h91 = 'T'+'a'+'n'+'k'+'e'+'r'+' '+'('+'n'+'o'+' '+'a'+'d'+'d'+'i'+'t'+'i'+'o'+'n'+'a'+'l'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+')';
  static const int h92 = 'O'+'t'+'h'+'e'+'r';
  static const int h93 = 'O'+'t'+'h'+'e'+'r'+' '+'c'+'a'+'r'+'r'+'y'+'i'+'n'+'g'+' '+'d'+'a'+'n'+'g'+'e'+'r'+'o'+'u'+'s'+' '+'g'+'o'+'o'+'d'+'s';
  ...
  static const int h97 = 'O'+'t'+'h'+'e'+'r'+' '+'('+'n'+'o'+' '+'a'+'d'+'d'+'i'+'t'+'i'+'o'+'n'+'a'+'l'+' '+'i'+'n'+'f'+'o'+'r'+'m'+'a'+'t'+'i'+'o'+'n'+')';
  // EPFD fix types
  ...
  // AtoN Type
  static const int h112 = 'D'+'e'+'f'+'a'+'u'+'l'+'t'+':'+' '+'T'+'y'+'p'+'e'+' '+'o'+'f'+' '+'A'+'t'+'o'+'N'+' '+'n'+'o'+'t'+' '+'s'+'p'+'e'+'c'+'i'+'f'+'i'+'e'+'d';
  static const int h113 = 'R'+'e'+'f'+'e'+'r'+'e'+'c'+'e'+' '+'p'+'o'+'i'+'n'+'t';
  static const int h114 = 'R'+'A'+'C'+'O'+'N';
  static const int h115 = 'F'+'i'+'x'+'e'+'d'+' '+'s'+'t'+'r'+'u'+'c'+'t'+'u'+'r'+'e'+' '+'o'+'f'+'f'+'-'+'s'+'h'+'o'+'r'+'e';
  static const int h116 = 'R'+'e'+'s'+'e'+'r'+'v'+'e'+'d'+' '+'f'+'o'+'r'+' '+'f'+'u'+'t'+'u'+'r'+'e'+' '+'u'+'s'+'e';
  static const int h117 = 'F'+'i'+'x'+'e'+'d'+' '+'l'+'i'+'g'+'h'+'t'+':'+' '+'w'+'i'+'t'+'h'+'o'+'u'+'t'+' '+'s'+'e'+'c'+'t'+'o'+'r'+'s';
  static const int h118 = 'F'+'i'+'x'+'e'+'d'+' '+'l'+'i'+'g'+'h'+'t'+':'+' '+'w'+'i'+'t'+'h'+' '+'s'+'e'+'c'+'t'+'o'+'r'+'s';
  static const int h119 = 'F'+'i'+'x'+'e'+'d'+' '+'l'+'e'+'a'+'d'+'i'+'n'+'g'+' '+'l'+'i'+'g'+'h'+'t'+' '+'f'+'r'+'o'+'n'+'t';
  static const int h120 = 'F'+'i'+'x'+'e'+'d'+' '+'l'+'e'+'a'+'d'+'i'+'n'+'g'+' '+'l'+'i'+'g'+'h'+'t'+' '+'r'+'e'+'a'+'r';
  static const int h121 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'N';
  static const int h122 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'E';
  static const int h123 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'S';
  static const int h124 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'W';
  static const int h125 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'p'+'o'+'r'+'t'+' '+'h'+'a'+'n'+'d';
  static const int h126 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'s'+'t'+'a'+'r'+'b'+'o'+'a'+'r'+'d'+' '+'h'+'a'+'n'+'d';
  static const int h127 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'p'+'r'+'e'+'f'+'e'+'r'+'r'+'e'+'d'+' '+'c'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'p'+'o'+'r'+'t'+' '+'h'+'a'+'n'+'d';
  static const int h128 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'p'+'e'+'f'+'e'+'r'+'r'+'e'+'d'+' '+'c'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'s'+'t'+'a'+'r'+'b'+'o'+'a'+'r'+'d'+' '+'h'+'a'+'n'+'d';
  static const int h129 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'i'+'s'+'o'+'l'+'a'+'t'+'e'+'d'+' '+'d'+'a'+'n'+'g'+'e'+'r';
  static const int h130 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'s'+'a'+'f'+'e'+' '+'w'+'a'+'t'+'e'+'r';
  static const int h131 = 'F'+'i'+'x'+'e'+'d'+' '+'b'+'e'+'a'+'c'+'o'+'n'+':'+' '+'s'+'p'+'e'+'c'+'i'+'a'+'l'+' '+'m'+'a'+'r'+'k'; // Missing in canboat!
  static const int h132 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'N';
  static const int h133 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'E';
  static const int h134 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'S';
  static const int h135 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'c'+'a'+'r'+'d'+'i'+'n'+'a'+'l'+' '+'W';
  static const int h136 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'p'+'o'+'r'+'t'+' '+'h'+'a'+'n'+'d'+' '+'m'+'a'+'r'+'k';
  static const int h137 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'s'+'t'+'a'+'r'+'b'+'o'+'a'+'r'+'d'+' '+'h'+'a'+'n'+'d'+' '+'m'+'a'+'r'+'k';
  static const int h138 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'p'+'r'+'e'+'f'+'e'+'r'+'r'+'e'+'d'+' '+'c'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'p'+'o'+'r'+'t'+' '+'h'+'a'+'n'+'d';
  static const int h139 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'p'+'r'+'e'+'f'+'e'+'r'+'r'+'e'+'d'+' '+'c'+'h'+'a'+'n'+'n'+'e'+'l'+' '+'s'+'t'+'a'+'r'+'b'+'o'+'a'+'r'+'d'+' '+'h'+'a'+'n'+'d';
  static const int h140 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'i'+'s'+'o'+'l'+'a'+'t'+'e'+'d'+' '+'d'+'a'+'n'+'g'+'e'+'r';
  static const int h141 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'s'+'a'+'f'+'e'+' '+'w'+'a'+'t'+'e'+'r';
  static const int h142 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'s'+'p'+'e'+'c'+'i'+'a'+'l'+' '+'m'+'a'+'r'+'k';
  static const int h143 = 'F'+'l'+'o'+'a'+'t'+'i'+'n'+'g'+' '+'A'+'t'+'o'+'N'+':'+' '+'l'+'i'+'g'+'h'+'t'+' '+'v'+'e'+'s'+'s'+'e'+'l'+'/'+'L'+'A'+'N'+'B'+'Y'+'/'+'r'+'i'+'g'+'s';
  // Assigned Mode Flag
  static const int h144 = 'A'+'u'+'t'+'o'+'n'+'o'+'m'+'o'+'u'+'s'+' '+'a'+'n'+'d'+' '+'c'+'o'+'n'+'t'+'i'+'n'+'u'+'o'+'u'+'s';
  ...
  for (i = 0 ; i < sizeof(eType) / sizeof(aisKey) ; i++ ) {
    if ( eType[i].hash == h && !strcmp(fieldName, eType[i].value) ) break;
  }
  base = eType[i].first;
  ...
  // Find enum value
  {
    ...
    if ( getJSONValue(msg, fieldName, jsonString, sizeof(jsonString)) ) {
      for ( i = 0 ; jsonString[i] != '\0' ; i++ ) k += jsonString[i];
      for ( i = base ; i < base + elements ; i++ ) {
        if ( eValue[i].hash == k && !strcmp(jsonString, eValue[i].value) ) break;
      }
      if ( k ) return eValue[i].num;
...
char* aisAtoNName(const char *msg, bool extended, int* len)
{
  ...
  if (!getJSONValue(msg, "AtoN Name", jsonString, sizeof(jsonString))) jsonString[0] = '\0';
  jsonString[34] = '\0';
...
void nmea0183AIVDM( StringBuffer * msg183, int source, const char * msg )
{
  ...
  if (!getJSONValue(msg, "pgn", jstr, sizeof(jstr))) return;
  pgn = atoi(jstr);
