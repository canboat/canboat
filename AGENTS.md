...
> AND the Rust tables (`crates/canboat-core/src/schema_generated.rs`,
> `crates/canboat-io/src/fastpacket_generated.rs`) are
...
| `crates/canboat-core/src/schema_generated.rs` | **generated** | `keel generate` output (~5.6 MB): the Rust PGN tables `canboat-core` compiles in. Committed, not built — see §3. |
| `crates/canboat-io/src/fastpacket_generated.rs` | **generated** | `keel generate` output: fast-packet framing for PGNs 0x1F000..0x1FFFF. |
...
database/  (YAML — SOURCE OF TRUTH: pgns/, lookups/, fieldtypes.yaml, j1939/)
   ...
   docs/canboat.xml (2.3 MB)  +  analyzer/lookup-generated-data.h + analyzer/*-data.h (C tables)
        │                        +  crates/canboat-core/src/schema_generated.rs (Rust tables)
