...
//!
//! This is the near-inverse of [`crate::engine::output::write_json`]: given a
...
mod tests {
    ...
    fn camel_and_bare_decode_the_same_record() {
        let db = crate::engine::PgnDatabase::embedded(Units::Metric);
    ...
    fn key_style_sniffing() {
        let info = crate::engine::PgnDatabase::embedded(Units::Si)
            .first_pgn(130306)
