...
//! [`crate::Database::encode`] → [`crate::PgnBuilder`]. Anything you can
//! do here you can do from a program:
//!
//! ```no_run
//! use canboat::{Database, Units, ids::field::iso_request};
...
use crate::engine::format::{actisense_ascii, ebl, plain, ydwg02};
use crate::engine::{PgnBuilder, PgnDatabase, PgnInfo, Units};
use anyhow::bail;
