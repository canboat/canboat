...
//!
//! These are the *decode-time* quirks from [`crate::engine::quirk`] —
...
use crate::engine::quirk::{self, Target};
...
impl DecodeQuirk {
    /// Switch this quirk on in the engine.
    pub fn enable(&self) {
        match self {
