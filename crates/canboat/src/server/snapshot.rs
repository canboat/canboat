...
use crate::engine::{DecodedField, DecodedPgn, FieldValue, PgnDatabase};
...
/// TTL / emit responsibilities to [`crate::engine::snapshot`].
///
...
impl SnapshotStore {
    ...
    /// n2kd feeds directly.
    pub fn core(&self) -> Arc<crate::engine::snapshot::SnapshotStore> {
...
fn top_field_text(decoded: &DecodedPgn, f: &crate::engine::FieldInfo) -> Option<String> {
    decoded
        .fields
        .iter()
...
mod tests {
    ...
    fn collect_iter_indexes_is_sorted_and_deduplicated() {
        ...
        use crate::engine::{DecodedField, DecodedPgn, FieldValue};
