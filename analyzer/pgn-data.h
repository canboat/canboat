...
Pgn pgnList[] = {
    ...
    {"Garmin Autopilot Key Value Data",
     126720,
     PACKET_FIELDS_UNKNOWN | PACKET_FIELD_LENGTHS_UNKNOWN | PACKET_RESOLUTION_UNKNOWN | PACKET_NOT_SEEN,
     PACKET_FAST,
     {
      {.name = "Manufacturer Code", .camelName = "manufacturerCode", .fieldType = "LOOKUP", .size = 11, .resolution = 1.0, .unit = "=229", .lookup.type = LOOKUP_TYPE_PAIR, LOOKUP_PAIR_MEMBER = lookupMANUFACTURER_CODE, .lookup.name = "MANUFACTURER_CODE"},
      {.name = "Reserved", .camelName = "reserved", .fieldType = "RESERVED", .size = 2, .resolution = 1.0},
      {.name = "Industry Code", .camelName = "industryCode", .fieldType = "LOOKUP", .size = 3, .resolution = 1.0, .unit = "=4", .lookup.type = LOOKUP_TYPE_PAIR, LOOKUP_PAIR_MEMBER = lookupINDUSTRY_CODE, .lookup.name = "INDUSTRY_CODE"},
      {.name = "Sub-protocol ID", .camelName = "subProtocolId", .fieldType = "UINT16", .resolution = 1.0, .unit = "=5904", .partOfPrimaryKey = true},
      {.name = "Wrapper Byte 1", .camelName = "wrapperByte1", .fieldType = "UINT8", .resolution = 1.0, .unit = "=4"},
      {.name = "Wrapper Byte 2", .camelName = "wrapperByte2", .fieldType = "UINT8", .resolution = 1.0, .unit = "=4"},
      {.name = "Field Group", .camelName = "fieldGroup", .fieldType = "UINT8", .resolution = 1.0, .unit = "=17", .partOfPrimaryKey = true},
      {.name = "Count", .camelName = "count", .fieldType = "UINT8", .resolution = 1.0, .unit = "=3"},
      {.name = "Key", .camelName = "key", .fieldType = "DYNAMIC_FIELD_KEY", .size = 8, .resolution = 1.0, .lookup.type = LOOKUP_TYPE_FIELDTYPE, LOOKUP_FIELDTYPE_MEMBER = lookupGARMIN_AP_KEY, .lookup.name = "GARMIN_AP_KEY"},
      {.name = "Value", .camelName = "value", .fieldType = "DYNAMIC_FIELD_VALUE"}
     },
     .camelDescription = "garminAutopilotKeyValue",
     .priority = 7,
     .repeatingCount1 = 2,
     .repeatingStart1 = 9,
     .repeatingField1 = 8},
    ...
    {"Garmin Autopilot: Heading to Steer",
     ...
     PACKET_FAST,
     {
      ...
      {.name = "Reserved", .camelName = "reserved", .fieldType = "RESERVED", .size = 2, .resolution = 1.0},
      {.name = "Industry Code", .camelName = "industryCode", .fieldType = "LOOKUP", .size = 3, .resolution = 1.0, .unit = "=4", .lookup.type = LOOKUP_TYPE_PAIR, LOOKUP_PAIR_MEMBER = lookupINDUSTRY_CODE, .lookup.name = "INDUSTRY_CODE"},
      {.name = "Sub-protocol ID", .camelName = "subProtocolId", .fieldType = "UINT16", .resolution = 1.0, .unit = "=5904", .lookup.type = LOOKUP_TYPE_PAIR, LOOKUP_PAIR_MEMBER = lookupGARMIN_SUB_PROTOCOL, .lookup.name = "GARMIN_SUB_PROTOCOL", .partOfPrimaryKey = true},
      {.name = "Wrapper Byte 1", .camelName = "wrapperByte1", .fieldType = "UINT8", .resolution = 1.0, .unit = "=4"},
      {.name = "Wrapper Byte 2", .camelName = "wrapperByte2", .fieldType = "UINT8", .resolution = 1.0, .unit = "=4"},
      {.name = "Field Group", .camelName = "fieldGroup", .fieldType = "UINT8", .resolution = 1.0, .unit = "=0"},
      {.name = "Field", .camelName = "field", .fieldType = "UINT8", .resolution = 1.0, .unit = "=11", .partOfPrimaryKey = true},
      {.name = "Reserved", .camelName = "reserved9", .fieldType = "RESERVED", .size = 8, .resolution = 1.0},
      {.name = "Heading to Steer", .camelName = "headingToSteer", .fieldType = "FLOAT_RAD", .resolution = 1.0, .hasSign = true}
     },
