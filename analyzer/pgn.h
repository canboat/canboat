...
Pgn pgnList[] = {
    ...
    {"Seatalk1: Pilot Mode",
     ...
     PACKET_FAST,
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 240, "0x81f0"),
      MATCH_FIELD("command", BYTES(2), 33921, "0x84"),
    ...
    {"Seatalk1: Pilot Hull Type",
     ...
     PACKET_FAST,
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 108, "0x166C"),
      MATCH_FIELD("command", BYTES(2), 20495, "0x50"),
    ...
    {"Seatalk1: Keystroke",
     ...
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 240, "0x81f0"),
      MATCH_FIELD("command", BYTES(1), 34433, "0x86"),
      UINT8_FIELD("device"),
    ...
    {"Seatalk1: Device Identification",
     ...
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 240, "0x81f0"),
      MATCH_FIELD("command", BYTES(2), 36993, "0x90"),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Seatalk1: Display Brightness",
     ...
     PACKET_FAST,
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 140, "0x0c8c"),
      MATCH_FIELD("command1", BYTES(1), 12, "0x90"),
    ...
    {"Seatalk1: Display Color",
     ...
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 140, "0x0c8c"),
      MATCH_FIELD("command1", BYTES(1), 12, "0x0c"),
      LOOKUP_FIELD("Group", BYTES(1), SEATALK_NETWORK_GROUP),
      BINARY_FIELD("Unknown 1", BYTES(1), NULL),
