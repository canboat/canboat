...
#define TIME_FIELD(nam)                                                                    \
  {                                                                                        \
    .name = nam, .size = BYTES(4), .resolution = RES_TIME, .units = "s", .description = "" \
  }

#define DATE_FIELD(nam)                                                                       \
  {                                                                                           \
    .name = nam, .size = BYTES(2), .resolution = RES_DATE, .units = "days", .description = "" \
  }
...
Pgn pgnList[] = {
    ...
    {"Time & Date",
     ...
     8,
     0,
     {DATE_FIELD("Date"), TIME_FIELD("Time"), {"Local Offset", BYTES(2), RES_INTEGER, true, "minutes", "Minutes"}, {0}}}
