    ...
    */
    ...
    {"Fusion: Tuner",
     ...
     {COMPANY(419),
      ...
      LOOKUP_FIELD("Source ID", BYTES(1), FUSION_RADIO_SOURCE),
    ...
    {"Fusion: MARINE_TUNER",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD("Message ID", BYTES(2), 32780, FUSION_MESSAGE_ID),
      UINT8_FIELD("Source ID"),
      UINT8_FIELD("Channel"),
      UINT8_FIELD("Signal Strength"),
      STRINGVAR_FIELD("Name"),
    ...
    {"Fusion: Setting",
      ...
      .priority = 7,
      .fallback = true,
      .explanation = "Fallback for all Fusion settings"}
