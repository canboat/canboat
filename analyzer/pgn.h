...
Pgn pgnList[] = {
    ...
    {"Fusion: Request Status",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 1, FUSION_MESSAGE_ID),
      UINT8_FIELD("Unknown"),
      END_OF_FIELDS}}
    ...
    {"Fusion: Set Source",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 2, FUSION_MESSAGE_ID),
      UINT8_FIELD("Unknown"),
      UINT8_FIELD("Source ID"),
      END_OF_FIELDS}}
    ...
    {"Fusion: Set Zone Volume",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 24, FUSION_MESSAGE_ID),
      UINT8_FIELD("Unknown"),
      UINT8_FIELD("Zone"),
      UINT8_FIELD("Volume"),
      END_OF_FIELDS}}
    ...
    {"Fusion: Set All Volumes",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 25, FUSION_MESSAGE_ID),
      UINT8_FIELD("Unknown"),
      UINT8_FIELD("Zone1"),
      UINT8_FIELD("Zone2"),
      UINT8_FIELD("Zone3"),
